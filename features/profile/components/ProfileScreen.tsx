    ...
    <ScrollView className="flex-1" style={{ backgroundColor: colors.background }}>
      <View className="gap-4 p-4">
        ...
        <View className="gap-3 items-center p-6 rounded-2xl mb-5 bg-card shadow-sm">
          ...
          <Text className="text-base text-muted-foreground mb-4">{userEmail}</Text>
          <Pressable
        ...
        <View className="gap-2 p-5 rounded-2xl mb-5 bg-card shadow-sm">
          ...
          <View className="flex-row items-center justify-between py-3 border-b border-border">
            <View className="flex-1 mr-4">
              <Text className="text-base font-medium text-foreground mb-1">Notifications</Text>
          ...
          <View className="flex-row items-center justify-between py-3">
            <View className="flex-1 mr-4">
              <Text className="text-base font-medium text-foreground mb-1">Dark Mode</Text>
              <Text className="text-sm text-muted-foreground">
        ...
        <View className="gap-4 p-5 rounded-2xl mb-5 bg-card shadow-sm">
          <Text className="text-xl font-semibold text-foreground">Learning Stats</Text>
          <View className="flex-row justify-around">
            {[
              ...
              <View key={item.label} className="items-center">
                ...
                <Text className="text-xs text-muted-foreground text-center">{item.label}</Text>
              </View>
            ))}
          </View>
        </View>
