...
export default function WellKnownWordsCard({ wellKnown, total }: WellKnownWordsCardProps) {
  ...
  return (
    <GlassCard accentColors={["#6ee7b7", "#10b981"]} style={{ flex: 1 }}>
      <View className="items-center justify-center p-4">
        ...
        <View
          style={[styles.progressTrack, { backgroundColor: barBg, marginTop: 10 }]}
          className="w-full"
        >
          <LinearGradient
            ...
            style={[styles.progressFill, { width: pct > 0 ? `${Math.max(2, pct)}%` : "0%" }]}
          />
        </View>
